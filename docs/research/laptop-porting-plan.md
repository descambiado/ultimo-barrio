...
## 7. Estado por commit � handoff 2026-08-08 (rama spike/laptop-content-stack)

| SHA | Dominio | Estado | Dependencias | Portable | Adapter requerido |
|---|---|---|---|---|---|
| 9839846 | weapons USP | RUNTIME VALIDATED | w_usp/v_usp cloud | s� | IWeaponContentAdapter/IDamageTarget |
| 6913adb | weapons crowbar | RUNTIME VALIDATED | crowbar01 engine | s� | idem |
| 9fd7b32 | weapons suite 4/4 + PackageReferences | RUNTIME VALIDATED | 9 idents cloud | s� | idem |
| d2e1132 | QA WeaponSuite | RUNTIME VALIDATED | � | s� | no |
| 21d199f | QA ContentRuntimeSuite | RUNTIME VALIDATED | � | s� | no |
| 9055be6 | QA stubs suites | STATIC ONLY | � | s� | no |
| 494b21b | building assets (9 prefabs) | STATIC ONLY | engine models | s� | no |
| 4249201/87e176f/b79dea3 | building system | STATIC ONLY | � | s� | IFortificationContentAdapter/BuildStructureHost |
| 7222416/8a71468 | enemies assets | STATIC ONLY | citizen + loot | s� | IEnemyContentAdapter |
| cc16de7 | audio bank | STATIC ONLY (sin compile) | facepunch sounds + MIT dry_fire | s� | no |
| d4c0c93 (agent/enemies) | enemy system WIP | WIP (sin compilar) | � | s� (pendiente) | IEnemyContentAdapter |
| e871fe7 (checkpoint) | diagn�stico building + open_scene | WIP (roto building_lab) | � | s� (open_scene) | no |
