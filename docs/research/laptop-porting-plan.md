...
| 9 | `1d2047f` | feat(content): enemigos (3 prefabs) + loot | `Assets/prefabs/content/enemies/*.prefab` | Hosts de enemigos (commit 3) | Assets VERIFIED 2026-08-08: citizen.vmdl + citizen.vanmgrph + skins (engine content), ammobox9mm/12g, w_trenchknife, crowbar01; diferenciacion por Scale+Tint (sin assets nuevos); loot medicine sin modelo real (deferred); EULA T5 pendiente | Sistema de NPC/raids del core; flip AssetsVerified en enemycontentregistry.cs; ItemRegistry: anadir ammo_12g/weapon_knife; quitar o diferir entrada medicine | **SÍ** (JSON puro) | 3 |
